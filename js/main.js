...
async function handleData() {
  ...
  console.log(data);
  titles[0].innerText = data[0].original_title;
  covers[0].src = `https://image.tmdb.org/t/p/w200${data[0].poster_path}`;
  descriptions[0].innerText = data[0].overview;
  scores[0].innerText = '★' + data[0].vote_average;
}
